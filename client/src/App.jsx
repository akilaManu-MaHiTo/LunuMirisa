...
const ProtectedRoute = () => {
  ...
  if (loading) {
    return <Loader />; // Show a loading spinner while fetching user data
  }
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route
            path="/TableReservationPage/:userId"
            element={<TableReservationPage />}
          />
          <Route
            path="/ReservedTables/:id/:userId"
            element={<ReservedTables />}
          />
          <Route
            path="/InOrder/:id/:userId/:tableNum/:date/:ongoing"
            element={<InOrder />}
          />
          <Route path="/Navigation" element={<Navigation />} />
          <Route path="/AddSupplier" element={<AddSupplier />} />
          <Route
            path="/ShowSupplierProfiles"
            element={<ShowSupplierProfiles />}
          />
          <Route
          ...
          />
          <Route
            path="/ShowSupplierCategory"
            element={<ShowSupplierCategory />}
          />
          <Route
            path="/UpdateSupplierCategory/:id"
            element={<UpdateSupplierCategory />}
          />
          <Route path="/UserCart" element={<UserCart />} />
          <Route path="/SignInSupplier" element={<SupplierLogin />} />
          <Route
            path="/SupplierManagerDashBoard"
            element={<SupplierManagerDashBoard />}
          />
          <Route
          ...
          />
          <Route
            path="/PlaceOrderInventory/:id"
            element={<PlaceOrderInventory />}
          />
          <Route
            path="/UpdateSupplier/:id"
            element={<UpdateSupplierprofiles />}
          />
          ...
          <Route
            path="/SupplierConfirmOrder/:supplierId/:orderId/:supplierName/:image"
            element={<SupplierConfirmOrder />}
          />
          ...
          />
          <Route
            path="CartForm/:userId/:totalPrice/:cartItemsJson"
            element={<CartForm />}
          />
          ...
          <Route
            path="/ShowUserReviews/:userId"
            element={<ShowUserReviews />}
          />
          <Route path="/ShowAdminReviews" element={<ShowAdminReviews />} />
          <Route path="/ShowAcceptedOrders" element={<ShowAcceptedOrders />} />
          <Route
            path="/MyTableReservations/:userId"
            element={<MyTableReservations />}
          />
          <Route
            path="/UpdateReservedTables/:reserveId/:userId"
            element={<UpdateReservedTables />}
          />
          <Route path="/CheffInventory" element={<CheffInventory />} />
          <Route
            path="/UpdateInventoryByCheff/:id"
            element={<UpdateInventoryByCheff />}
          />
