    ...
    <div className="min-h-screen bg-custom-black">
      ...
      <div className="flex items-center justify-center bg-custom-black mt-10">
        <div className="bg-white p-6 rounded shadow-md w-full max-w-[106rem]">
          ...
          {/* Inventory List */}
          <div className="grid grid-cols-6 text-gray-600 mb-4 font-semibold space-x-3 mt-16">
            <span>Image</span>
            <span>Item Name</span>
              ...
              <ul>
                {filteredInventory.map((item) => (
                  <li key={item._id} className="bg-slate-200 grid grid-cols-6 mb-4 p-4 border rounded items-center space-x-6 border-custom-black">
                    ...
                    <div><Link to={`/UpdateInventoryByCheff/${item._id}`}><button>Update  <FontAwesomeIcon icon={faPenToSquare} /></button></Link></div>
