...
function SupplierDashboard() {
  ...
  return (
    <div>
      <AdminNaviBar selectedPage="Supplier Dashboard" />
        <div className="min-h-screen bg-gradient-to-r from-gray-900 to-gray-700 text-white py-12 dark:bg-gray-900 transition-colors duration-500"
                style={{ 
                  backgroundImage: `url(${bgSuppliar})`, 
            ...
            <div className="flex flex-col items-center space-y-12">
              ...
              <div className=''>
                ...
                <div className="bg-gray-800 shadow-xl rounded-lg p-8 w-full max-w-4xl">
                  <h2 className="text-3xl font-light text-white mb-8 text-center">Supplier Profile</h2>
                ...
                <div className="w-full max-w-4xl">
                  <div className="bg-gray-800 shadow-lg rounded-lg p-6 flex justify-around items-center">
                    <button
                      ...
                      ${!showOrderRequests ? 'bg-white text-black' : 'bg-black text-white dark:bg-black dark:text-white'}`}
                ...
                <div className="bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-4xl">
                  {showOrderRequests ? (
                            ...
                            <div key={order._id} className="p-6 mb-6 border-b border-gray-600">
                              ...
                              <div className="flex justify-end mt-4 space-x-4">
                                <Link to={`/SupplierConfirmOrder/${supplierData._id}/${order._id}/${supplierData.name}/${order.image}`}>
                                  <button
                                    className="bg-green-500 hover:bg-white text-white hover:text-black py-2 px-4 rounded transition duration-500"
                                  >
                                    Accept
                                  </button>
                                </Link>
                                <button
                                  className="bg-red-600 hover:bg-white hover:text-black text-white py-2 px-4 rounded transition duration-500"
                    ...
                    <div>
                      <h2 className="text-2xl font-semibold text-white mb-8 text-center">Accepted Orders</h2>
                      <input
                        type="date"
