...
const Sidebar = React.forwardRef(({ isVisible }, ref) => {
  return (
    <aside
      ref={ref}
      className={`fixed pl-10 pr-10 pt-10 top-28 left-0 h-[calc(100%-4rem)] w-[30rem] bg-custom-gray shadow-md transform transition-transform duration-300 ease-in-out ${
