...
const ReviewsTable = () => {
  ...
  useEffect(() => {
    Axios.get("http://localhost:3000/GetAllReviews")
      .then((response) => {
  ...
  const handleStatusChange = (id, status) => {
    Axios.put(`http://localhost:3000/UpdateReviewStatus/${id}`, { Status: status })
      .then((response) => {
  ...
  const handleReply = (id, reply) => {
    Axios.put(`http://localhost:3000/UpdateReviewReply/${id}`, { reply })
      .then((response) => {
