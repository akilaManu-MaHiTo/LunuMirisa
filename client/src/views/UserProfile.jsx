...
function UpdateUsers() {
    ...
    const handleUpdate = (e) => {
        ...
        axios.post("http://localhost:3000/ProfileImage", formData)
            .then(result => {
                if (result.data.alreadyExists) {
                    return axios.put("http://localhost:3000/ProfileImage", formData);
                }
            })
            .then(() => {
                return axios.put(`http://localhost:3000/updateUser/${userId}`, updatedUserData);
            })
            .then(() => {
                            ...
                            <div className="text-center mb-8">
                                <div className="flex items-center justify-center w-30">
                                    <div className="relative w-40 h-40">
                                        <img 
                                            src={previewImage || (profile.image ? `http://localhost:3000/Images/${profile.image}` : defaultProfilePic)} 
                                            alt="Profile" 
