...
const LoginUser = () => {
  ...
  return (
    ...
    <Navigation logo={logo} /> 
      <div className='flex justify-center items-center min-h-screen bg-custom-light w-screen'>
        <div className='flex w-full sm:w-3/4 bg-custom-dark shadow-md mt-16 '>
          {/* Form Container */}
          <div className='w-full sm:w-1/2 p-6 sm:p-8 mt-36'>
            <form onSubmit={Submit}>
              <h2 className='text-center text-white font-spartan font-semibold text-[4rem] mb-16'>Login</h2>
              <div className='mb-4'>
                <label className='block text-white text-center mb-2'>E-mail</label>
                <input
                  type="email"
              ...
              <div className='mb-4'>
                <label className='block text-white  text-center mb-2'>Password</label>
                <input
                  type="password"
