...
const Footer = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const result = await axios.get(`http://localhost:3000/getUser/${userId}`);
    ...
    useEffect(() => {
        const fetchProfilePic = async () => {
            try {
                const response = await axios.get(`http://localhost:3000/ShowProfilePic/${userId}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            await axios.post('http://localhost:3000/PlaceReview', data);
