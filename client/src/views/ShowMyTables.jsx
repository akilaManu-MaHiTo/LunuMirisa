  ...
  useEffect(() => {
    const fetchTables = async () => {
      try {
        ...
        const reservationResponse = await axios.get(`http://localhost:3000/getReservationByUserId/${userId}`);
  ...
  useEffect(() => {
    const fetchPaymentDetails = async () => {
      try {
        ...
        const paymentResponse = await axios.get(`http://localhost:3000/paymentGetByUserId/${userId}`);
