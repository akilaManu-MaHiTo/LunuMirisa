    ...
    <div>
      ...
      <div className="relative flex w-full h-full">
        ...
        <div className="absolute text-white hidden custom-md:flex justify-center text-2xl w-full mt-[50rem]">
          <div className="font-spartan font-thin bg-custom-black p-4 opacity-70">
            {" "}
            Order Now ↓{" "}
          </div>
        </div>
      ...
      <div className="text-white text-5xl pt-20 font-spartan font-thin pl-[10rem]">
        Today's Special
      </div>
      ...
      <div className="flex justify-center gap-y-8">
        <div className="flex flex-wrap gap-x-16 gap-y-8 pt-16 pb-10 justify-center w-[80rem]">
          {[...Array(3)].map((_, index) => (
            <div
              key={index}
              className="bg-custom-gray p-6 rounded shadow-md w-[18rem] h-auto max-w-md mb-4 md:mb-0 flex flex-col items-center transition-all duration-500 ease-in-out transform hover:scale-105"
            >
              <img
                src={food}
                alt="food"
                className="w-[15rem] h-auto rounded mx-auto mt-2"
              />
              <div className="text-center text-white font-spartan font-thin mt-8 text-2xl">
                Chicken Biriyani
              </div>
              <div className="text-center text-white font-spartan font-thin text-xl mt-2">
                Rs.1700/-
              </div>
              <button
                type="submit"
              ...
              >
                <FontAwesomeIcon icon={faCartPlus} className="mr-2" /> Add to
                Cart
              </button>
            </div>
          ))}
