                    ...
                    {data.length > 0 ? (
                        data.map((item, index) => (
                            <div key={index} className="bg-custom-gray p-6 rounded shadow-md w-[18rem] h-auto max-w-md mb-4 md:mb-0 flex flex-col items-center transition-all duration-500 ease-in-out transform hover:scale-105">
                                ...
                                <div className="text-center text-white font-spartan font-thin mt-8 text-2xl">{item.name}</div>
                                <div className="text-center text-white font-spartan font-thin text-xl mt-2">Rs.{item.price}/-</div>
