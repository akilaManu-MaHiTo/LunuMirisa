...
const AddEmployeeForm = () => {
  ...
  return (
    <div>
    <AdminNavigationBar selectedPage="Add Employee"></AdminNavigationBar>
    <div className="flex justify-center items-center  bg-black" style={{marginTop:'15px'}}>
      ...
      <form className="bg-white p-6 rounded-lg shadow-lg " style={{width:'600px'}} onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full bg-blue-500 text-white py-1 rounded-lg hover:bg-blue-600 transition duration-300" style={{marginTop:"10px"}}
        >
          Add Employee
        </button>
      </form>
