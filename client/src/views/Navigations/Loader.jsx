...
const Loader = () => {
  ...
  return (
<div className="bg-custom-light p-4  flex items-center justify-center min-h-screen">
  <div className=" text-custom-white font-poppins font-medium text-xl box-border h-10 p-2 flex rounded-md">
    <p>Loading</p>
